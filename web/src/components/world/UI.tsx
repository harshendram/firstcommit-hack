...
export function Volume3(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/**
 * A figure pitched forward over a ground line, with two speed ticks behind.
 *
 * Drawn in the same house style as `Run` next to it — 24×24, `currentColor`,
 * no fill, 2px round joins — because it sits in that same control cluster.
 */
export function Stumble(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      <g
        ...
        strokeWidth="2"
      >
        <path d="M16 5a1 1 0 1 0 2 0a1 1 0 1 0-2 0"></path>
        <path d="M16.4 7.8L11.2 11.2M16.4 7.8L19 11.6M14.2 9.2L11.2 7.6M11.2 11.2L7.4 10.1M11.2 11.2L9.2 15.3"></path>
        <path d="M4 19h16" opacity="0.45"></path>
        <path d="M4.6 8.4h2.2M3.2 12h2.2" opacity="0.45"></path>
      </g>
    </svg>
  );
}
